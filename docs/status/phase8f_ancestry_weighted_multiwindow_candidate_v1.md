...
Historical note: Phase8F is now the base method promoted by the Phase9D decision.
The current repository default is tracked in `docs/current_default.md`.
...
Recommended modes:
- t0.50: balanced/default candidate for this historical Phase8F milestone
