...
Historical note: this document describes the Phase7G stable/default state at the
time it was written. The current repository default is tracked in
`docs/current_default.md`.

Phase7G was the stable/default learned gate for AWPhase panel-assisted short-read phasing at this milestone.
